...
from .views import index, product, about, add_to_cart, cart_detail, checkout, register, generate_invoice, contact_view, contact_success, privacy_policy, terms_of_service, login
